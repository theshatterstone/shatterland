...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/powerarrow-icons-blue"
local iconsdir                                  = os.getenv("HOME") .. "/.config/awesome/themes/"
theme.wallpaper                                 = theme.dir .. "/wallpaper.jpg"
-- theme.font                                      = "Noto Sans Regular 11"
theme.font                                      = "Ubuntu Bold 10"
theme.icons_font                                = "Ubuntu Bold 11"
theme.taglist_font                              = "Ubuntu Bold 9.5"
...
local brighticon = wibox.widget.imagebox(theme.brightnessicon)
-- local brightnessicon = awful.widget.watch(
--     "echo ' 󱄄  ' ", 60,
--     function(widget, stdout)
--         widget:set_markup(" " .. markup.fontfg(theme.icons_font, "#c678dd", stdout))
--     end
-- )

-- local brighticon = awful.widget.watch(
--     -- "echo 'CPU: ' ", 60,
--     "echo ' 󱄄  ' ", 60,
--     function(widget, stdout)
--         widget:set_markup(" " .. markup.fontfg(theme.icons_font, "#282c34", stdout))
--     end
-- )
...
local brightness = awful.widget.watch(
    "cat " .. gears.filesystem.get_configuration_dir() .. "brightness", 1,
    function(widget, stdout)
...
local layoutname = awful.widget.watch(
    "cat " .. gears.filesystem.get_configuration_dir() .. "layoutname", 1,
    function(widget, stdout)
        widget:set_markup(" " .. markup.fontfg(theme.font, "#dfdfdf", stdout))
    end
)
...
local mainSep1 = awful.widget.watch(
    "echo '◢' ", 60,
    function(widget, stdout)
        widget:set_markup(" " .. markup.fontfg("Ubuntu Mono 50", "#467b96", stdout))
    end
)
...
local dateicon = awful.widget.watch(
    -- "echo 'CPU: ' ", 60,
    "echo '󰃭 ' ", 60,
    function(widget, stdout)
        widget:set_markup(" " .. markup.fontfg(theme.icons_font, "#dfdfdf", stdout))
    end
)
...
local baticon = awful.widget.watch(
    "echo '  ' ", 60,
    function(widget, stdout)
        widget:set_markup(" " .. markup.fontfg(theme.icon_font, "#dfdfdf", stdout))
    end
)
   ...
   s.quake = lain.util.quake({ app = "urxvt", height = 0.50, argname = "--name %s" })
	...
	spacing = -7,
        ...
        { -- Right widgets
            ...
            wibox.container.background(wibox.container.margin(wibox.widget { mainSep1, layout = wibox.layout.align.horizontal }, dpi(bar_widget_sep_margin_left), dpi(bar_widget_sep_margin_right)), "#282c34"),
            wibox.container.background(wibox.container.margin(wibox.widget { brighticon, brightness, layout = wibox.layout.align.horizontal }, dpi(0), dpi(8)), "#467b96"),
            -- arrow("#467b96", "#889fa7"),
            wibox.container.background(wibox.container.margin(wibox.widget { mainSep2, layout = wibox.layout.align.horizontal }, dpi(bar_widget_sep_margin_left), dpi(bar_widget_sep_margin_right)), "#467b96"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, dpi(0), dpi(8)), "#889fa7"),
            wibox.container.background(wibox.container.margin(wibox.widget { mainSep1, layout = wibox.layout.align.horizontal }, dpi(bar_widget_sep_margin_left), dpi(bar_widget_sep_margin_right)),"#889fa7"),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, dpi(0), dpi(8)), "#467b96"),
            wibox.container.background(wibox.container.margin(wibox.widget { mainSep2, layout = wibox.layout.align.horizontal }, dpi(bar_widget_sep_margin_left), dpi(bar_widget_sep_margin_right)),"#467b96"),
            wibox.container.background(wibox.container.margin(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal }, dpi(0), dpi(8)), "#889fa7"),
            -- arrow("#497B96", "#889FA7"),
            ...
            wibox.container.background(wibox.container.margin(wibox.widget { mainSep1, layout = wibox.layout.align.horizontal }, dpi(bar_widget_sep_margin_left), dpi(bar_widget_sep_margin_right)),"#889fa7"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, dpi(0), dpi(8)), "#497B96"),
            wibox.container.background(wibox.container.margin(wibox.widget { mainSep2, layout = wibox.layout.align.horizontal }, dpi(bar_widget_sep_margin_left), dpi(bar_widget_sep_margin_right)),"#467b96"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume, layout = wibox.layout.align.horizontal }, dpi(0), dpi(8)), "#889FA7"),
            wibox.container.background(wibox.container.margin(wibox.widget { mainSep1, layout = wibox.layout.align.horizontal }, dpi(bar_widget_sep_margin_left), dpi(bar_widget_sep_margin_right)),"#889fa7"),
            wibox.container.background(wibox.container.margin(wibox.widget { dateicon, clock, layout = wibox.layout.align.horizontal }, dpi(0), dpi(8)), "#497B96"),
            -- wibox.container.background(wibox.widget { mainSep2, layout = wibox.layout.align.horizontal }, "#467b96"),
            --]]
            -- wibox.layout.margin(wibox.widget.systray(), 1, 1, 3, 3), --order of padding values is: left, right, top, bottom
            -- s.mylayoutbox,
