...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/powerarrow-blue-new"
   ...
   s.quake = lain.util.quake({ app = "urxvt", height = 0.50, argname = "--name %s" })
	...
	spacing = -7,
        ...
        { -- Right widgets
            ...
            wibox.container.background(wibox.container.margin(wibox.widget { brightnessicon, brightness, layout = wibox.layout.align.horizontal }, dpi(0), dpi(8)), "#467b96"),
            -- arrow("#467b96", "#889fa7"),
