...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/dt-like-doom"
...
local mem = lain.widget.mem({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, "#c678dd", mem_now.used .. "M " .. "/" .. mem_now.total .. "M"))
    end
})
...
local volicon = awful.widget.watch(
    "echo 'Vol: ' ", 60,
    function(widget, stdout)
        widget:set_markup(" " .. markup.fontfg(theme.font, "#62bfff", stdout))
    end
)
theme.volume = lain.widget.alsa({
    settings = function()
        if volume_now.status == "off" then
            widget:set_markup(markup.fontfg(theme.font, "#62bfff", "M"))
        -- elseif tonumber(volume_now.level) == 0 then
        --     volicon:set_image(theme.widget_vol_no)
        -- elseif tonumber(volume_now.level) <= 50 then
        --     volicon:set_image(theme.widget_vol_low)
        else
            widget:set_markup(markup.fontfg(theme.font, "#62bfff", volume_now.level .. "%"))
        end
   ...
   s.quake = lain.util.quake({ app = "urxvt", height = 0.50, argname = "--name %s" })
	...
	spacing = -7,
        ...
        { -- Right widgets
            ...
            wibox.container.background(wibox.container.margin(wibox.widget { brightnessicon, brightness, layout = wibox.layout.align.horizontal}, dpi(0), dpi(0), dpi(0), dpi(2), "#ff6c6b"), "#282c34"),
            -- arrow("#467b96", "#889fa7"),
            wibox.container.background(wibox.container.margin(wibox.widget { mainSep, layout = wibox.layout.align.horizontal }, dpi(bar_widget_sep_margin_left), dpi(bar_widget_sep_margin_right)), "#282c34"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, dpi(0), dpi(0), dpi(0), dpi(2), "#98be65"), "#282c34"),
            wibox.container.background(wibox.container.margin(wibox.widget { mainSep, layout = wibox.layout.align.horizontal }, dpi(bar_widget_sep_margin_left), dpi(bar_widget_sep_margin_right)),"#282c34"),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, dpi(0), dpi(0), dpi(0), dpi(2), "#ecbe7b"), "#282c34"),
            wibox.container.background(wibox.container.margin(wibox.widget { mainSep, layout = wibox.layout.align.horizontal }, dpi(bar_widget_sep_margin_left), dpi(bar_widget_sep_margin_right)),"#282c34"),
            wibox.container.background(wibox.container.margin(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal }, dpi(0), dpi(0), dpi(0), dpi(2), "#da8548"), "#282c34"),
            -- arrow("#497B96", "#889FA7"),
            ...
            wibox.container.background(wibox.container.margin(wibox.widget { mainSep, layout = wibox.layout.align.horizontal }, dpi(bar_widget_sep_margin_left), dpi(bar_widget_sep_margin_right)),"#282c34"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume, layout = wibox.layout.align.horizontal }, dpi(0), dpi(0), dpi(0), dpi(2), "#62bfff"), "#282c34"),
            wibox.container.background(wibox.container.margin(wibox.widget { mainSep, layout = wibox.layout.align.horizontal }, dpi(bar_widget_sep_margin_left), dpi(bar_widget_sep_margin_right)),"#282c34"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, dpi(0), dpi(0), dpi(0), dpi(2), "#c678dd"), "#282c34"),
            wibox.container.background(wibox.container.margin(wibox.widget { mainSep, layout = wibox.layout.align.horizontal }, dpi(bar_widget_sep_margin_left), dpi(bar_widget_sep_margin_right)),"#282c34"),
            wibox.container.background(wibox.container.margin(clock, dpi(0), dpi(0), dpi(0), dpi(2), "#46d9ff"), "#282c34"),
