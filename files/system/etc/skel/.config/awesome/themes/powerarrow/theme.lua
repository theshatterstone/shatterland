...
theme.fg_focus                                  = "#467b96"
theme.fg_urgent                                 = "#467b96"
theme.bg_normal                                 = "#282a36"
theme.bg_focus                                  = "#467b96"
theme.bg_urgent                                 = "#3F3F3F"
theme.taglist_fg_focus                          = "#ffffff"
theme.tasklist_bg_focus                         = "#000000"
theme.tasklist_fg_focus                         = "#A77AC4"
theme.border_width                              = 2
theme.border_normal                             = "#889fa7"
theme.border_focus                              = "#467b96"
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, 4, 7), "#343434"),
            -- arrow("alpha", "#467b96"),
            -- wibox.container.background(wibox.container.margin(wibox.widget { mpdicon, theme.mpd.widget, layout = wibox.layout.align.horizontal }, 3, 6), "#467b96"),
            -- arrow("#467b96", "#889fa7"),
            ...
            arrow("#343434", "#467b96"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#467b96"),
            arrow("#467b96", "#889fa7"),
            ...
            arrow("#889fa7", "#467b96"),
            wibox.container.background(wibox.container.margin(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal }, 4, 4), "#467b96"),
            arrow("#467b96", "#889fa7"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.bar, layout = wibox.layout.align.horizontal }, 2, 3), "#889fa7"),
            -- arrow("#467b96", "#889fa7"),
            ...
            arrow("#889fa7", "#467b96"),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#467b96"),
            arrow("#467b96", "#889fa7"),
            ...
            arrow("#889fa7", "#467b96"),
            wibox.container.background(wibox.container.margin(clock, 4, 8), "#467b96"),
            arrow("#467b96", "alpha"),
            --]]
            s.mylayoutbox,
        },
