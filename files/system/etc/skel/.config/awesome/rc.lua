...
local themes = {
    "powerarrow", -- 1 NOT SUPPORTED DO NOT USE
    "powerarrow-blue", -- 2 NOT SUPPORTED DO NOT USE
    "powerarrow-blue-pulse", -- 3 NOT SUPPORTED DO NOT USE
    "powerarrow-blue-new", -- 4
    "powerarrow-icons-blue", -- 5
    "powerarrow-blue-new-arrow", -- 6
    "doom-one-custom", -- 7 NEEDS SOME WORK
    "doom-one-custom-pulse", -- 8 NOT SUPPORTED DO NOT USE
    "dt-like-doom", -- 9
    "dt-like-blue", -- 10
}
...
local browser     = "floorp" -- brave or firefox
local fileman     = "thunar"
local editor      = "vim"
local emacs       = "emacsclient -c -a 'emacs' "
local mediaplayer = "vlc"
local music       = terminal .. " -e cmus"
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, "Shift" }, "m", function () awful.spawn( music ) end,
              {description = "Launch music player", group = "awesome"}),
    awful.key({ modkey,         }, "p", function () awful.spawn( "rofi -show drun -display-drun ' Desktop: '" ) end,
              {description = "Launch rofi drun", group = "awesome"}),
    awful.key({ modkey,         }, "r", function () awful.spawn( "rofi -show run -display-run ' Run: '" ) end,
              {description = "Launch rofi run", group = "awesome"}),
    awful.key({ modkey,         }, "e", function () awful.spawn( emacs ) end,
              {description = "Launch emacs", group = "awesome"}),
    awful.key({ modkey,         }, "v", function () awful.spawn( "feh --bg-fill --randomize /home/shatterstone/wallpapers" ) end,
    ...
    awful.key({ modkey, "Shift" }, "b", function () awful.util.mymainmenu:show() end,
    ...
    --     function ()
    --         awful.spawn.with_shell("amixer -q set %s 100%%", beautiful.volume.channel))
    --         beautiful.volume.update()
    --     end),
    -- awful.key({ ctrlkey, "Shift" }, "0",
    --     function ()
    --         awful.spawn.with_shell("amixer -q set %s 0%%", beautiful.volume.channel))
    --         beautiful.volume.update()
    --     end),
...
awful.rules.rules = {
    ...
    { rule = { },
      properties = { border_width = beautiful.border_width,
                    ...
                    -- Spawn new windows as slave, instead of master
...
awful.spawn.with_shell(gears.filesystem.get_configuration_dir() .. "brightness.sh")
awful.spawn.with_shell(gears.filesystem.get_configuration_dir() .. "layoutname.sh")
...
-- awful.spawn.with_shell("feh --randomize --bg-fill /home/shatterstone/wallpapers")
