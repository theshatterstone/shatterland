  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>ff', function()
        require('telescope.builtin').find_files { hidden = true, cwd = vim.loop.os_homedir() }
      ...
      -- Function to search files in a specified directory
      ...
      -- vim.api.nvim_set_keymap('n', '<leader>.', ':lua SearchFilesInDir()<CR>', { noremap = true, silent = true })
