...
# Added decorations from qtile extras
...
keys = [
         ...
         Key([mod], "p",
             lazy.spawn("rofi -show drun -display-drun ' Desktop: '"),
             desc='Rofi'
             ),
         Key([mod], "d",
...
layouts = [
    ...
    layout.MonadTall(margin=7, border_width=3, border_focus="#467b96", border_normal="#889fa7"),
