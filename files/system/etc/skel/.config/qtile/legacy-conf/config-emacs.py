...
if qtile.core.name == "x11":
    ...
    #  drun = "wofi --show drun"
     drun = "j4-dmenu-desktop --dmenu=\"bemenu --hb '#467b96' --hf '#dfdfdf' --tb '#467b96' --tf '#dfdfdf' -H 20 --fn 'Hack' -p 'Desktop:' -i -w --fork\" --term=kitty --usage-log=$HOME/.local/share/j4-dmenu-desktop.log --no-generic"
